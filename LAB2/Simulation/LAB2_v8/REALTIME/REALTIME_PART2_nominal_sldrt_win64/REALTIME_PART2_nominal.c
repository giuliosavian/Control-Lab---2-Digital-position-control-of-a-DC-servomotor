...
static void rate_scheduler(void)
{
   ...
   */
  (REALTIME_PART2_nominal_M->Timing.TaskCounters.TID[2])++;
  if ((REALTIME_PART2_nominal_M->Timing.TaskCounters.TID[2]) > 49) {/* Sample time: [0.05s, 0.0s] */
    REALTIME_PART2_nominal_M->Timing.TaskCounters.TID[2] = 0;
  }

  REALTIME_PART2_nominal_M->Timing.sampleHits[2] =
    (REALTIME_PART2_nominal_M->Timing.TaskCounters.TID[2] == 0);
}
...
void REALTIME_PART2_nominal_output(void)
{
  ...
  if (rtmIsMajorTimeStep(REALTIME_PART2_nominal_M) &&
      REALTIME_PART2_nominal_M->Timing.TaskCounters.TID[2] == 0) {
    /* Step: '<Root>/Step' */
    if (REALTIME_PART2_nominal_M->Timing.t[2] <
     ...
     *  Gain: '<S1>/deg2rad'
     */
    rtb_thl_meas = REALTIME_PART2_nominal_P.deg2rad *
      REALTIME_PART2_nominal_B.thl_ref;

    /* Gain: '<S1>/Input feedforward' */
    rtb_Inputfeedforward = REALTIME_PART2_nominal_P.N_u * rtb_thl_meas;

    /* Gain: '<S1>/State feedforward	' incorporates:
     *  Sum: '<S1>/Sum2'
     */
    rtb_Sum2_idx_0 = rtb_thl_meas * REALTIME_PART2_nominal_P.N_x[0];
    rtb_Sum2_idx_1 = rtb_thl_meas * REALTIME_PART2_nominal_P.N_x[1];
    ...
    /* Gain: '<Root>/pulse2deg' */
    REALTIME_PART2_nominal_B.pulse2deg =
      REALTIME_PART2_nominal_P.sens.enc.pulse2deg * rtb_thl_meas;
     ...
     *  Gain: '<Root>/Gain'
     */
    REALTIME_PART2_nominal_B.Sum[0] = REALTIME_PART2_nominal_P.H0[0] *
      REALTIME_PART2_nominal_DW.DiscreteStateSpace_DSTATE +
      REALTIME_PART2_nominal_P.Gain_Gain[0] * rtb_thl_meas;
    REALTIME_PART2_nominal_B.Sum[1] = REALTIME_PART2_nominal_P.H0[1] *
      REALTIME_PART2_nominal_DW.DiscreteStateSpace_DSTATE +
      REALTIME_PART2_nominal_P.Gain_Gain[1] * rtb_thl_meas;

    /* Sum: '<S1>/Sum' incorporates:
     *  Gain: '<S1>/State feedback'
     *  Sum: '<S1>/Sum2'
     */
    rtb_Inputfeedforward += (rtb_Sum2_idx_0 - REALTIME_PART2_nominal_B.Sum[0]) *
      REALTIME_PART2_nominal_P.Statefeedback_Gain[0] + (rtb_Sum2_idx_1 -
      REALTIME_PART2_nominal_B.Sum[1]) *
      REALTIME_PART2_nominal_P.Statefeedback_Gain[1];

    /* Saturate: '<S1>/Saturation' */
    if (rtb_Inputfeedforward > REALTIME_PART2_nominal_P.Saturation_UpperSat) {
      /* Saturate: '<S1>/Saturation' */
      REALTIME_PART2_nominal_B.Saturation =
        REALTIME_PART2_nominal_P.Saturation_UpperSat;
    } else if (rtb_Inputfeedforward <
      ...
      /* Saturate: '<S1>/Saturation' */
      REALTIME_PART2_nominal_B.Saturation = rtb_Inputfeedforward;
    }
   ...
   */
  REALTIME_PART2_nominal_B.wlrpm = (REALTIME_PART2_nominal_P.SpeedFilter_C[0] *
    REALTIME_PART2_nominal_X.SpeedFilter_CSTATE[0] +
    REALTIME_PART2_nominal_P.SpeedFilter_C[1] *
    REALTIME_PART2_nominal_X.SpeedFilter_CSTATE[1]) *
    REALTIME_PART2_nominal_P.degs2rpm;
  if (rtmIsMajorTimeStep(REALTIME_PART2_nominal_M) &&
      REALTIME_PART2_nominal_M->Timing.TaskCounters.TID[1] == 0) {
  }

  if (rtmIsMajorTimeStep(REALTIME_PART2_nominal_M) &&
      REALTIME_PART2_nominal_M->Timing.TaskCounters.TID[2] == 0) {
    /* SignalConversion generated from: '<Root>/Discrete State-Space' */
    REALTIME_PART2_nominal_B.TmpSignalConversionAtDiscreteStateSpaceInport1[0] =
      REALTIME_PART2_nominal_B.Saturation;
    REALTIME_PART2_nominal_B.TmpSignalConversionAtDiscreteStateSpaceInport1[1] =
      rtb_thl_meas;
  }
}
...
void REALTIME_PART2_nominal_update(void)
{
  if (rtmIsMajorTimeStep(REALTIME_PART2_nominal_M) &&
    ...
    REALTIME_PART2_nominal_DW.DiscreteStateSpace_DSTATE =
      (REALTIME_PART2_nominal_P.PHI *
       REALTIME_PART2_nominal_DW.DiscreteStateSpace_DSTATE +
       REALTIME_PART2_nominal_P.GAMMA[0] *
       REALTIME_PART2_nominal_B.TmpSignalConversionAtDiscreteStateSpaceInport1[0])
      + REALTIME_PART2_nominal_P.GAMMA[1] *
      REALTIME_PART2_nominal_B.TmpSignalConversionAtDiscreteStateSpaceInport1[1];
  }
  ...
  if (rtmIsMajorTimeStep(REALTIME_PART2_nominal_M) &&
     ...
     */
    if (!(++REALTIME_PART2_nominal_M->Timing.clockTick2)) {
      ++REALTIME_PART2_nominal_M->Timing.clockTickH2;
    }

    REALTIME_PART2_nominal_M->Timing.t[2] =
      REALTIME_PART2_nominal_M->Timing.clockTick2 *
      REALTIME_PART2_nominal_M->Timing.stepSize2 +
      REALTIME_PART2_nominal_M->Timing.clockTickH2 *
      REALTIME_PART2_nominal_M->Timing.stepSize2 * 4294967296.0;
  }
...
void REALTIME_PART2_nominal_derivatives(void)
{
  ...
  _rtXdot->SpeedFilter_CSTATE[0] += REALTIME_PART2_nominal_P.SpeedFilter_A[0] *
    REALTIME_PART2_nominal_X.SpeedFilter_CSTATE[0];
  _rtXdot->SpeedFilter_CSTATE[1] = 0.0;
  _rtXdot->SpeedFilter_CSTATE[0] += REALTIME_PART2_nominal_P.SpeedFilter_A[1] *
    REALTIME_PART2_nominal_X.SpeedFilter_CSTATE[1];
  _rtXdot->SpeedFilter_CSTATE[1] += REALTIME_PART2_nominal_X.SpeedFilter_CSTATE
    [0];
  _rtXdot->SpeedFilter_CSTATE[0] += REALTIME_PART2_nominal_B.pulse2deg;
}
...
void REALTIME_PART2_nominal_initialize(void)
{
  ...
  REALTIME_PART2_nominal_DW.DiscreteStateSpace_DSTATE =
    REALTIME_PART2_nominal_P.DiscreteStateSpace_InitialCondition;
  ...
  REALTIME_PART2_nominal_X.SpeedFilter_CSTATE[0] = 0.0;
  REALTIME_PART2_nominal_X.SpeedFilter_CSTATE[1] = 0.0;
}
...
RT_MODEL_REALTIME_PART2_nominal_T *REALTIME_PART2_nominal(void)
{
  ...
  /* Initialize timing info */
  {
    ...
    REALTIME_PART2_nominal_M->Timing.sampleTimes[2] = (0.05);

    /* task offsets */
    REALTIME_PART2_nominal_M->Timing.offsetTimes[0] = (0.0);
    REALTIME_PART2_nominal_M->Timing.offsetTimes[1] = (0.0);
    REALTIME_PART2_nominal_M->Timing.offsetTimes[2] = (0.0);
  }
  ...
  REALTIME_PART2_nominal_M->Timing.stepSize2 = 0.05;

  /* External mode info */
  REALTIME_PART2_nominal_M->Sizes.checksums[0] = (1221425635U);
  REALTIME_PART2_nominal_M->Sizes.checksums[1] = (1027798384U);
  REALTIME_PART2_nominal_M->Sizes.checksums[2] = (2067281056U);
  REALTIME_PART2_nominal_M->Sizes.checksums[3] = (2466913845U);
  ...
  REALTIME_PART2_nominal_M->Sizes.numSampTimes = (3);/* Number of sample times */
  REALTIME_PART2_nominal_M->Sizes.numBlocks = (19);/* Number of blocks */
  REALTIME_PART2_nominal_M->Sizes.numBlockIO = (6);/* Number of block outputs */
  REALTIME_PART2_nominal_M->Sizes.numBlockPrms = (40);/* Sum of parameter "widths" */
