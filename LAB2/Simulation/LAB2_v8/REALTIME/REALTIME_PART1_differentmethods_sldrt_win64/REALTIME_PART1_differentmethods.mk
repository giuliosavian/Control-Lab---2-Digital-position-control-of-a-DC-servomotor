...
MODEL                := REALTIME_PART1_differentmethods
MODULES              := REALTIME_PART1_differentmethods_data.c REALTIME_PART1_differentmethods_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := REALTIME_PART1_differentmethods.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := REALTIME_PART1_differentmethods_ref.rsp
...
# additional includes
REQ_INCLUDES += ;Z:/windows_profile/Desktop/LAB2_v7/REALTIME;Z:/windows_profile/Desktop/LAB2_v7/REALTIME/REALTIME_PART1_differentmethods_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
