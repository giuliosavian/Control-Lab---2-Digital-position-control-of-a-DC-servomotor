/*
 * REALTIME_PART2_robust_exact_data.c
 *
...
P_REALTIME_PART2_robust_exact_T REALTIME_PART2_robust_exact_P = {
  /* Variable: ctrl
   * Referenced by:
   *   '<S1>/K_w'
   *   '<S1>/K_w1'
   ...
   */
  { 9.1133480553644, 0.26574290831529074 },
