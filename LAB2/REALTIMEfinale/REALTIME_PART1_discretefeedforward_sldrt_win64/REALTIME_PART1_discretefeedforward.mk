...
MODEL                := REALTIME_PART1_discretefeedforward
MODULES              := REALTIME_PART1_discretefeedforward_data.c REALTIME_PART1_discretefeedforward_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := REALTIME_PART1_discretefeedforward.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := REALTIME_PART1_discretefeedforward_ref.rsp
...
# additional includes
REQ_INCLUDES += ;Z:/windows_profile/Desktop/REALTIME;Z:/windows_profile/Desktop/REALTIME/REALTIME_PART1_discretefeedforward_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
