  ...
  *REALTIME_PART1_discretefeedforward(void)
{
  ...
  /* External mode info */
  REALTIME_PART1_discretefeedforward_M->Sizes.checksums[0] = (3587552589U);
  REALTIME_PART1_discretefeedforward_M->Sizes.checksums[1] = (2952948338U);
  REALTIME_PART1_discretefeedforward_M->Sizes.checksums[2] = (481500872U);
  REALTIME_PART1_discretefeedforward_M->Sizes.checksums[3] = (3756009429U);
