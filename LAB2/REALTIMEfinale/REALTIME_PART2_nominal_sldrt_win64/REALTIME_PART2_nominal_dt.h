...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&REALTIME_PART2_nominal_B.thl_ref), 0, 0, 8 }
  ,

  { (char_T *)(&REALTIME_PART2_nominal_DW.DiscreteStateSpace_DSTATE), 0, 0, 1 },

  { (char_T *)(&REALTIME_PART2_nominal_DW.EncoderInput_PWORK), 11, 0, 6 }
};
...
static DataTypeTransition rtPTransitions[] = {
  ...
  { (char_T *)(&REALTIME_PART2_nominal_P.GAMMA[0]), 0, 0, 18 },

  { (char_T *)(&REALTIME_PART2_nominal_P.EncoderInput_Channels), 6, 0, 4 },

  { (char_T *)(&REALTIME_PART2_nominal_P.Step_Time), 0, 0, 17 }
};
